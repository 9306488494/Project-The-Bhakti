...
public class Tab11 extends Fragment {
   ...
   /* private AdView adView;*/
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // Add data into list
        /*Dharma dharma=new Dharma(val);
        dharmaList1.add(dharma);*/
   ...
   /*     // FB native ads Banner
        ...
        String Url="http://shivagod.in/Prabhu/dharma.php";
    ...
    private void parseData(String response) {
        try {
            ...
            for(int i=0;i<jsonArray.length();i++)
            {
                ...
                RecyclerAdapterGanesha recyclerAdapterGanesha =new RecyclerAdapterGanesha(getContext(),ganeshaList1);
