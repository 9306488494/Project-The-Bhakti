...
public class RecyclerAdapterGanesha3 extends RecyclerView.Adapter<RecyclerAdapterGanesha3.GaneshaViewholder> {
    Context mcontext;

    ArrayList<Ganesha> ganeshaList;

    public RecyclerAdapterGanesha3(Context mcontext, List<Ganesha> ganeshaList) {
