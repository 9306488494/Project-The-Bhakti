 ...
 * {@link NewUserTab1.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link NewUserTab1#newInstance} factory method to
 * create an instance of this fragment.
 */
public class NewUserTab1 extends Fragment {
     ...
     * @return A new instance of fragment NewUserTab1.
     */
    // TODO: Rename and change types and number of parameters
    public static NewUserTab1 newInstance(String param1, String param2) {
        NewUserTab1 fragment = new NewUserTab1();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_new_user_tab1, container, false);
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if(task.isSuccessful())
                {
                    for(QueryDocumentSnapshot doc:task.getResult())
                    {
                        ...
                        if(Objects.equals(doc.getString("user_status"), "unseen")) {
                            ...
                            userslist.add(listedUsers);
                            Collections.reverse(userslist);
                            RecyclerAdapterUserLists recyclerAdapterUserLists = new RecyclerAdapterUserLists(getActivity(), userslist);
                            chatUserRec.setHasFixedSize(true);
                            chatUserRec.setLayoutManager(new LinearLayoutManager(getActivity()));
                            chatUserRec.setAdapter(recyclerAdapterUserLists);
