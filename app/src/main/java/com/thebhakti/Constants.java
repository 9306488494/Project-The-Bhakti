...
public class Constants {
    public static final String M_ID = "PwMSta75478518317092"; //Paytm Merchand Id we got it in paytm credentials
    ...
    public static final String CALLBACK_URL = "https://prabhudarshan.in/paytm/paytmchecksum/paytmCallback";
}
