...
public class RecyclerAdapterGanesha5 extends RecyclerView.Adapter<RecyclerAdapterGanesha5.GaneshaViewholder> {
    Context mcontext;

    ArrayList<Ganesha> ganeshaList;

    public RecyclerAdapterGanesha5(Context mcontext, List<Ganesha> ganeshaList) {
