...
class RecyclerAdapterMymsg2 extends RecyclerView.Adapter<RecyclerAdapterMymsg2.MymsgViewholder> {
    Context mcontext;
    ArrayList<Mymsg> msglist;

    public RecyclerAdapterMymsg2(Context mcontext, ArrayList<Mymsg> msglist) {
    ...
    public MymsgViewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view;
        view= LayoutInflater.from(mcontext).inflate(R.layout.userchat_lay2,parent,false);
