...
public class Recharge100 extends AppCompatActivity implements PaytmPaymentTransactionCallback {
  ...
  /* Time and Date */
    ...
    private void generateCheckSum100() {
        ...
        call.enqueue(new Callback<Checksum>() {
            ...
            public void onResponse(@NonNull Call<Checksum> call, @NonNull Response<Checksum> response) {
                ...
                initializePaytmPayment100(response.body().getChecksumHash(), paytm);
            }
    ...
    private void initializePaytmPayment100(String checksumHash, Paytm paytm) {
...
/* First findout the document id and then update data*/
                ...
                /*Now we will update the amount in wallet after successful transaction via paytm*/
                        ...
                        qry2.addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void aVoid) {
                                Toast.makeText(Recharge100.this, "प्रिय प्रभु भक्ति उपभोगता , आपके वॉलेट में 25 रु आ गए है |", Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
                }
        ...
        qry3.get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if(task.isSuccessful())
                {
                    ...
                    {
                        Toast.makeText(Recharge100.this, "Unable to Detect your Details", Toast.LENGTH_SHORT).show();
                    }
                    else
                    {
                        for(QueryDocumentSnapshot doc:task.getResult())
    ...
    public void networkNotAvailable() {
        ...
        Intent intent1=new Intent(Recharge100.this,MyWallet2.class);
