...
public class RecyclerAdapterGanesha extends RecyclerView.Adapter<RecyclerAdapterGanesha.GaneshaViewholder> {
    Context mcontext;

    private ArrayList<Ganesha> ganeshaList;

    RecyclerAdapterGanesha(Context mcontext, List<Ganesha> ganeshaList) {
    ...
    @NonNull
    @Override
    public GaneshaViewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view;
        view= LayoutInflater.from(mcontext).inflate(R.layout.item_tab0,parent,false);
    ...
    class GaneshaViewholder extends RecyclerView.ViewHolder {
        private CardView cardMain;
        private ImageView ImgLoad;
        private TextView textView;

       //Create Constructor for bind UI Widget
       GaneshaViewholder(View itemView) {
            super(itemView);
